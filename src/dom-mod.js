export const DOMManipulator = (function() {
    function displayToDo(project) {
        for (let toDo of project) {
            ...
            const editBtn = document.createElement("svg");
            editBtn.setAttribute("xmlns", "http://www.w3.org/2000/svg");
            editBtn.setAttribute("viewBox", "0 0 24 24");
            const editBtnTitle = document.createElement("title");
            editBtnTitle.textContent = "Edit";
            editBtn.appendChild(editBtnTitle);
            const editBtnPath = document.createElement("path");
            editBtnPath.setAttribute("d", "M8,12H16V14H8V12M10,20H6V4H13V9H18V12.1L20,10.1V8L14,2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H10V20M8,18H12.1L13,17.1V16H8V18M20.2,13C20.3,13 20.5,13.1 20.6,13.2L21.9,14.5C22.1,14.7 22.1,15.1 21.9,15.3L20.9,16.3L18.8,14.2L19.8,13.2C19.9,13.1 20,13 20.2,13M20.2,16.9L14.1,23H12V20.9L18.1,14.8L20.2,16.9Z");
            editBtn.appendChild(editBtnPath);
            ...
            const deleteBtnTitle = document.createElement("title");
            deleteBtnTitle.textContent = "Delete";
            deleteBtn.appendChild(deleteBtnTitle);
            const deleteBtnPath = document.createElement("path");
